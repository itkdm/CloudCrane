...
export function WebsitesView({ websites, onWebsiteSelect }: WebsitesViewProps) {
  ...
  return (
    <main className="websites-page">
      ...
      {websites.length === 0 ? <p className="website-empty">{t('empty')}</p> : null}
          ...
          >
            ...
            <div className="website-preview-url">
              ...
              <button className="secondary-button" type="button" onClick={copyPreviewUrl}>
                {copiedPreviewUrl ? common('copied') : t('copyAddress')}
              </button>
            </div>
            <ol>
